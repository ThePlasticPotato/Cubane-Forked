...
export interface BlockStateMultipart {
    when?: BlockStateDefinitionVariant<string> | {
...
export type PackEventType = 'packAdded' | 'packRemoved' | 'packToggled' | 'packOrderChanged' | 'packsChanged' | 'atlasRebuilding' | 'atlasRebuilt' | 'loadProgress' | 'loadStart' | 'loadComplete' | 'loadError' | 'error';
